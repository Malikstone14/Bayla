            ...
            <div class="right-col">
                ...
                <form id="contact-form" action="email.markdownreservation" method="post">
                    ...
                    <select id="placement" name="placement">
                        <option disabled selected value> -- Selectionnez un emplacement -- </option>
                        <option value="intérieur">Intérieur</option>
                        <option value="extérieur">Exterieur</option>
                    </select>
                    <br  id="brheure">
                    <br  id="brheure">
                    <label id="serve" for="heure">Service</label>
                    <br>
                    <select id="lundi" name="heure">
